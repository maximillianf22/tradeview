import { join, relative, dirname, isAbsolute, resolve } from 'pathe';
import { watch } from 'chokidar';
import { useNuxt, tryResolveModule, createResolver, addTemplate, findPath, isNuxt3, addDevServerHandler, isNuxt2, useLogger, defineNuxtModule, resolvePath, getNuxtVersion, installModule, addVitePlugin } from '@nuxt/kit';
...
const resolveContentPaths = (srcDir) => [
...
async function setupViewer(twConfig, nuxt = useNuxt()) {
