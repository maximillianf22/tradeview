...
/* build-hook-start *//*00001*/try { require('/users/maximiliamfernandez/.vscode/extensions/wallabyjs.console-ninja-1.0.241/out/buildhook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///users/maximiliamfernandez/.vscode/extensions/wallabyjs.console-ninja-1.0.241/out/buildhook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
import EventEmitter from 'node:events';
import { c as chokidar } from '../shared/nuxi.fe6b052c.mjs';
import { c as consola } from '../shared/nuxi.c6444792.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
...
import { l as loadNuxtManifest, w as writeNuxtManifest } from '../shared/nuxi.adacabd3.mjs';
import { a as clearBuildDir } from '../shared/nuxi.6873bd7a.mjs';
